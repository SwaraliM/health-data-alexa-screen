...
let repromptText = " Whenever you are ready to respond, say Alexa and continue conversing. " + pauseDuration + " Do you want to continue?";

//let medCounter = 0;
//let remCounter = 0;
//let repeating = [  ];
//const apiInfoCall = 'https://chatgptmiddlemanapi.azurewebsites.net/api/WaitAPI/GetInforFromSheets';
...
/*const filler_questions = ["What's been the highlight of your week so far?", "Do you enjoy going outside?", "Are you a morning person or a night owl?", "Did you do anything new today?", "What's your typical day like?", 
    ...
    */
const smallTalkFillers1 = ["I'm still working on it, ", "It's taking me a bit longer, ", "Just a little longer, ", "This may take a few more seconds, " ];
const smallTalkFillers2 = ["hang tight. ", "Hang in there. ", "stay with me. ", "hold on. "];
const smallTalkFillers3 = ["Alright? ", "okay? "]
...
const LaunchRequestHandler = {
    canHandle(handlerInput) {
     ...
     async handle(handlerInput) {
        ...
        speakOutput = "Hi. Let's start the debrief. To access your healthcare management assistant say, I want to start the debrief.";
    //" + infoReceived.data.summaryGPT + "
        ...
        if (!questionAsked){
            ...
            reprompting = " Whenever you are ready to respond, say Alexa and continue conversing. " + pauseDuration + " Do you want to continue? ";
  ...
  async handle(handlerInput) {
   ...
   const directive = {
    ...
    if (speakOutput.data.GPTresponse  === "Still working on that"){
        tryAgain = "true";
        repromptText = "I did not get your response, if you want me to continue, say Alexa continue." + pauseDuration + " Should I continue?";
        ...
        */
        ...
        repromptText = " Whenever you are ready to respond, say Alexa and continue conversing. " + pauseDuration + " Do you want to continue?";
